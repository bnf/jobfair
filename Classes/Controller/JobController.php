...
class JobController extends ActionController
{
    ...
    public function initializeListAction()
    {
        ...
        if (isset($arguments['filter']['categories']) && (int)$arguments['filter']['categories'][0] === 0) {
            unset($arguments['filter']['categories']);
        }
        if (isset($arguments['filter']['regions']) && (int)$arguments['filter']['regions'][0] === 0) {
            unset($arguments['filter']['regions']);
        }
        if (isset($arguments['filter']['sectors']) && (int)$arguments['filter']['sectors'][0] === 0) {
            unset($arguments['filter']['sectors']);
        }
        if (isset($arguments['filter']['disciplines']) && (int)$arguments['filter']['disciplines'][0] === 0) {
            unset($arguments['filter']['disciplines']);
        }
        if (isset($arguments['filter']['educations']) && (int)$arguments['filter']['educations'][0] === 0) {
